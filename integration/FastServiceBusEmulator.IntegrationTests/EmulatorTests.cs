...
namespace FastServiceBusEmulator.IntegrationTests
{
    public class EmulatorTests: BaseServiceBusTest
    {
        ...
        public async Task Should_Send_And_Receive_Message()
        {
            ...
            var receiveTask = receiver.ReceiveMessageAsync(TimeSpan.FromSeconds(10), TestContext.Current.CancellationToken);
        ...
        public async Task Should_Send_To_Topic_And_Both_Subscriptions_Receive()
        {
            ...
            var receiveTask1 = receiver1.ReceiveMessageAsync(TimeSpan.FromSeconds(10), TestContext.Current.CancellationToken);
            var receiveTask2 = receiver2.ReceiveMessageAsync(TimeSpan.FromSeconds(10), TestContext.Current.CancellationToken);
